...
<svelte:head>
  ...
  <meta itemprop="image" content="felte-logo-filled.png">
  ...
  <meta property="og:image" content="felte-logo-filled.png">
  ...
  <meta name="twitter:image" content="felte-logo-filled.png">
</svelte:head>
